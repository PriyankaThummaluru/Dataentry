...
//                         $arr[1]=
                                    ...
                                    <input type="hidden" value="<?php echo $mainminimodi; ?>" name="mainminimodi" id="mainminimodi">
                                    <?php
                                    $srlnumbes="";
                                    foreach($srlnocheck as $srlkey=>$srlval){
                                        $srlnumbes .= $srlnocheck[$srlkey].",";
                                    }
                                    ?>
                                    <input type="hidden" value="<?php echo $srlnumbes; ?>" name="srlnocheck" id="srlnocheck">
                                    <?php
                                    $updatingfields="";
                                    foreach($updatefields as $fieldkey=>$fieldval){
                                        $updatingfields .= $updatefields[$fieldkey].",";
                                    }
                                    ?>
                                    <input type="hidden" value="<?php echo $updatingfields; ?>" name="updatingfields" id="updatingfields">
                                    <input type="hidden" value="<?php echo $filtertype; ?>" name="filtertype" id="filtertype">
                                                <select class="form-control  col-md-12 col-xs-12 select2" type="text" name="publication" id="publication" disabled>
                                                    <option value="">Select</option>
                                                </select>
                                            <?php } else {
                                                ?>
                                                <select class="form-control  col-md-12 col-xs-12 select2" type="text" name="publication11" id="publication11"  onchange="checkFilled('publication11')" >
...
//                                                            
                                                ...
                                                <?php } elseif ($namee == "priymulti") {
                                                     if(in_array("maincat", $updatefields) || in_array("subcat", $updatefields))
                                                    {
                                                        $ableordisable="";
                                                    }
                                                    else{
                                                        $ableordisable="disabled";
                                                    }
                                                    ?>
                                                <select class="form-control  col-md-12 col-xs-12 select2" type="text" name="maincat" id="maincat" <?php echo $ableordisable;?>>
                                                ...
                                                <?php } else {
                                                    ...
                                                    <select class="form-control  col-md-12 col-xs-12 select2 maincat" type="text" name="maincat" id="maincat" onchange="checkFilled('maincat')">
                                                        ...
                                                        foreach ($maincatname as $mainkey => $main) {
                                                            ...
                                                            if (strtoupper($maincatname[$mainkey]['advtmis_catg_mainname']) == strtoupper($dropdowndata[0]['advtmis_maincatgname'])) {
...
<?php if ($namee == "bhargavi") { ?>
                                                ...
                                                <?php } elseif ($namee == "priymulti") {
                                                    ...
                                                    ?>
                                                <select class="form-control  col-md-12 col-xs-12 select2" type="text" name="subcat" id="subcat" <?php echo $ableordisable;?>>
                                                        <option value=""></option>
                                                    </select>
                                                <?php } else {
                                                    ?>
                                                    <select class="form-control  col-md-12 col-xs-12 select2 subcat" type="text" name="subcat" id="subcat" onchange="checkFilled('subcat')"> 
                                                        ...
                                                        foreach ($maincategory as $mainkeyy => $mainvarr) {
                                                            if (strtoupper($maincategory[$mainkeyy]['advtmis_catg_subname']) == strtoupper($dropdowndata[0]['advtmis_subcatgname'])) {
//                                                             $sub="jsdklfjd";
...
<?php if ($namee == "bhargavi") { ?>
                                                ...
                                                <?php } elseif ($namee == "priymulti") {
                                                     if(in_array("place", $updatefields))
                                                    {
                                                        $ableordisable="";
                                                    }
                                                    else{
                                                    ...
                                                    ?>
                                                    <select class="form-control  col-md-12 col-xs-12 select2" type="text" name="place" id="place" <?php echo $ableordisable;?>>
                                                ...
                                                <?php } else {
                                                    ...
                                                    <select class="form-control  col-md-12 col-xs-12 select2 place" type="text" name="place" id="place" onchange="checkFilled('place')">
                                                        ...
                                                        foreach ($place as $placekey => $placevar) {
                                                            if (strtoupper($place[$placekey]['advtmis_rgn_place']) == strtoupper($dropdowndata[0]['advtmis_place'])) {
...
<?php if ($namee == "bhargavi") { ?>
                                                ...
                                                <?php } elseif ($namee == "priymulti") {
                                                    if(in_array("client", $updatefields) || in_array("product", $updatefields) || in_array("brand", $updatefields))
                                                    {
                                                        $ableordisable="";
                                                    }
                                                    else{
                                                    ...
                                                    ?>
                                                <select class="form-control  col-md-12 col-xs-12 select2 " type="text" name="client" id="client" <?php echo $ableordisable;?>>
...
<?php } ?>
    ...
    ?>
                                                <select class="form-control  col-md-12 col-xs-12 select2" type="text" name="product" id="product" <?php echo $ableordisable;?>>
                                                        <option value=""></option>
                                                    </select>
                                                <?php } else {
                                                    ?>
    ...
    ?>
                                                    <select class="form-control  col-md-12 col-xs-12 select2" type="text" name="brand" id="brand"  <?php echo $ableordisable;?>>
                                                        <option value=""></option>
                                                    </select>
                                                <?php } else {
                                                    ?>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-7">
                                                ...
                                                <?php } elseif ($namee == "priymulti") {
                                                     if(in_array("agency", $updatefields))
                                                    {
                                                        $ableordisable="";
                                                    }
                                                    else{
                                                    ...
                                                    ?>
                                                <select class="form-control  col-md-12 col-xs-12 select2" type="text" name="agency" id="agency" <?php echo $ableordisable;?> >
...
<?php if ($namee == "bhargavi") { ?>
                                            ...
                                            <?php } elseif ($namee == "priymulti") {
                                                ...
                                                <select class="form-control  col-md-12 col-xs-12 select2 color" type="text" name="color" id="color"  autocomplete="off" onchange="checkFilled('color')">
                                                    ...
                                                    if (!empty($dropdowndata[0]['advtmis_colbw'])) {
                                                        ?>
...
<?php if ($namee == "bhargavi") { ?>
                                            ...
                                            <?php } elseif ($namee == "priymulti") {
                                                 if(in_array("promoted", $updatefields))
                                                    {
                                                        $ableordisable="";
                                                    }
                                                    else{
                                                ...
                                                ?>
                                            <select class="form-control  col-md-12 col-xs-12 select2" type="text" name="promoted" id="promoted" <?php echo $ableordisable; ?>>
                                                    <!--<option value="">Select </option>-->
                                                    <option value="0">Direct</option>
                                                    <option value="1">Agency</option>
                                                    <option value="2">MMPL</option>
...
//        alert("first change");
//         let element = document.getElementById(id);
//      $('.comboTreeInputBox').on('change', function () {
//          alert("second change");
////            modsubcat_change();
//
// const colorboxes = document.querySelectorAll('.comboTreeInputBox');
//   colorboxes.forEach(el => {
//        el.style.backgroundColor = "paleturquoise";
//    });
////               element.style.backgroundColor = "paleturquoise";
...
//        alert(edi);
    ...
    function validateEntry() {
        ...
        var c = document.forms["myForm"]["editions1"].value;
        if (c == "") {
            alert("select publication editions");
            return false;
        }
...
//                                    var x = this.mst011_prodname;
        ...
        specialpages11();
        function specialpages11() {
            var public = $('#publication11').val();
            var pubcode = public.split('~');
            var radiotype = $("#mainmini11").val();
//                    alert(radiotype);
//                    alert(pubcode[1]);
            $.ajax({
...
//                            console.log(data);
                    if (subcat) {
                        ...
                        $(subcat).each(function () {
                            var option = $('<option />');
//           $maincategory[$key]['advtmis_catg_mainname'] . '~' . $maincategory[$key]['advtmis_catg_code'] . '~' . $maincategory[$key]['advtmis_catg_srlno'] . '~' . $maincategory[$key]['advtmis_catg_subname'] . '~' . $maincategory[$key]['advtmis_catg_adcode'];
...
// comboTree1.destroy();
        ...
        $('#publication11').on('change', function () {
        edition_change_modify();
    });
        $('#mainmini11').on('change', function () {
        edition_change_modify();
    });
...
//console.log(data);
                        console.log(data);
                        console.log("and also that they are the low of");
//                        let redata=data;
//console.log(myData);
//alert(data);
//obj comboTree1={};
